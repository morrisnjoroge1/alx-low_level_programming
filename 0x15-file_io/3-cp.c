...
/**
 * check98 - function checking file_from exists and can be read
...
/**
 * check97 - finction that checks for correct number of arguments
...
/**
 * check99 - function that file_to was created and/or can be written to
 * @check: checks if true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
...
/**
 * check100 - funtionc checking file descriptors were closed properly
